// PRODUCTION BUILD - 2025-10-31T01:59:37.940Z
// NUCLEAR CLEAN - All debug removed

const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbxaAzBDkFjavomppWls3F6-XIAcYwQERGHhbzx81-Zh2zUCCjNeNjDctnZdc1Vyyg9zYw/exec';
...
async function loadProgramsPreview() {
    ...
    try {
        ...
        // Fallback: tampilkan 3 program pertama
        else {
            programUnggulan = programsArray.slice(0, 3);
        }
        ...
        // Render program unggulan (sisa code sama...)
        container.innerHTML = programUnggulan.map(program => {
                    ...
                    <div class="program-sidebar">
                        <div class="pricing-card" style="background: var(--white); padding: 2rem; border-radius: var(--border-radius); box-shadow: var(--shadow-soft); position: sticky; top: 100px;">
                            ...
                            <div style="display: flex; flex-direction: column; gap: 1rem;">
                                ...
                                <button class="btn btn-outline"
                                    onclick="downloadBrosurProgram('${program.id_program}', '${program.nama_program}')"
...
async function loadProgramsForRegistration() {
    ...
    try {
        ...
        // FIX: Pastikan programs adalah array sebelum disimpan ke currentPrograms
        currentPrograms = Array.isArray(programs) ? programs : (programs?.data || []);
...
async function handlePrivateRegistration(e) {
    ...
    try {
        ...
        if (programId) {
            ...
            if (programData) { // ✅ GUNAKAN programData BUKAN program
        ...
        if (response.success) {
            ...
            // TAMBAHKAN INFORMASI PROMO DI PESAN SUKSES - GUNAKAN programData
